...
public class PersonInformation {
    ...
    public Long getCheck_out_timestamp() {
        return check_out_timestamp;
    }

    public void setCheck_out_timestamp(Long check_out_timestamp) {
    ...
    public Long getEmployed_date() {
        return employed_date;
    }

    public void setEmployed_date(Long employedDate) {
