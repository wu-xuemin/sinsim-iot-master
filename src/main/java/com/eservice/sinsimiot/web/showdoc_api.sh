...
# 
api_key="6cd8ff096c1fd20cdb21bd218a80e1d31962126302" 			#api_key
api_token="fcdd1c538c080ed6d763917bb46f3bd01784612488" 	#api_token
url="http://10.250.62.210:82/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.com.cn的不需要修改，使用私有版的请修改
#
#
#
#
